    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      <div className="stat-card">
        ...
        <div className="flex items-end gap-3">
          ...
          <div className="gauge text-xs" style={{ background: gaugeColor }}>
            {coverageScore}
          </div>
        </div>
        <div className="text-[11px] text-[#64748b] mt-1">
          Higher is stronger posture
        </div>
      </div>
      ...
      <div className="stat-card">
        ...
        <div className="text-5xl font-semibold tabular-nums tracking-tighter text-[#dc2626]">
          {gapsCount}
        </div>
        <div className="text-[11px] text-[#64748b] mt-1">
          Missing essential or recommended coverages
        </div>
      </div>
